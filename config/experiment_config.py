...
class SuicideDetectionConfig(ExperimentConfig):
    ...
    def __init__(self, positive_categories: Optional[List[str]] = None,
        ...
        # Use constants from the same package
        from .constants import SI_POSITIVE_CATEGORIES
        self._positive_categories = positive_categories or SI_POSITIVE_CATEGORIES
...
class AnalysisConfiguration:
    ...
    def create(cls, 
               ...
               timestamp: str,
               experiment_type: str,
               models_filter: Optional[Dict[str, List[str]]] = None) -> 'AnalysisConfiguration':
        """
